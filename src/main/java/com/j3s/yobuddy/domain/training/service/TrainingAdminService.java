...
public interface TrainingAdminService {
    ...
    Page<TrainingListItemResponse> getTrainingList(TrainingType type, Long programId,
    ...
    ProgramTrainingAssignResponse assignTrainingToProgram(Long programId, Long trainingId,
    ...
    ProgramTrainingsResponse getProgramTrainings(Long programId, Boolean includeUnassigned,
        String type);
    ...
    ProgramTrainingUpdateResponse updateProgramTraining(Long programId, Long trainingId,
