...
@Builder
@AllArgsConstructor
public class UserOnboardingPerformanceResponse {

    private Header header;                  // 상단 요약 영역
    private MentoringSection mentoringSection;
    ...
    @Builder
    @AllArgsConstructor
    public static class MentoringSection {

        private int totalMentoring;
        private int completedMentoring;
        private int notCompletedMentoring;
        private int noShowMentoring;
        private double completedMentoringRate;
        private double onTimeMentoringRate;
